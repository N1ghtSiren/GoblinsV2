...
---@return nothing
function SetUnitBasePrimaryStatById(unitTypeId, statIndex) end	-- (native)
...
---@param statIndex integer
---@return nothing
function SetHeroBasePrimaryStat(whichUnit, statIndex) end	-- (native)
...
---@return nothing
function SetUnitAttackTypeByIndex(whichUnit, atttackIndex, attackType) end	-- (native)
...
---@return nothing
function SetUnitWeaponTypeByIndex(whichUnit, atttackIndex, weaponType) end	-- (native)
...
---@param whichUnit unit
---@param armourType integer
---@return nothing
function SetUnitArmourType(whichUnit, armourType) end	-- (native)
...
---@param whichUnit unit
---@param primaryStatIndex integer
---@return nothing
function SetUnitPrimaryStat(whichUnit, primaryStatIndex) end	-- (native)
...
---@param state boolean
---@return nothing
function PauseUnitEx(whichUnit, state) end	-- (native)
...
---@param targY real
---@return boolean
function CastAbilityGround(whichAbility, source, targX, targY) end	-- (native)
...
--  uses SetTrackableSpaceRotation with XYZ orientation as default
