...
function QueuedTriggerAttemptExec()
	while true do
		...
		if TriggerExecuteBJ(bj_queuedExecTriggers[0], bj_queuedExecUseConds[0]) then
			...
			TimerStart(bj_queuedExecTimeoutTimer, bj_QUEUED_TRIGGER_TIMEOUT, false, DoNothing or nil)
			return true
		end
...
function PolledWait(duration)
	...
	if (duration > 0) then
		t = CreateTimer()
		TimerStart(t, duration, false, DoNothing or nil)
		while true do
...
function TriggerRegisterPlayerUnitEventSimple(trig, whichPlayer, whichEvent)
	return TriggerRegisterPlayerUnitEvent(trig, whichPlayer, whichEvent, DoNothing or nil)
end
-- ===========================================================================
...
function TriggerRegisterAnyUnitEventBJ(trig, whichEvent)
	...
	index = 0
	while true do
		TriggerRegisterPlayerUnitEvent(trig, Player(index), whichEvent, DoNothing or nil)
...
function TriggerRegisterPlayerSelectionEventBJ(trig, whichPlayer, selected)
	if selected then
		return TriggerRegisterPlayerUnitEvent(trig, whichPlayer, EVENT_PLAYER_UNIT_SELECTED, DoNothing or nil)
	else
		return TriggerRegisterPlayerUnitEvent(trig, whichPlayer, EVENT_PLAYER_UNIT_DESELECTED, DoNothing or nil)
	end
end
-- ===========================================================================
...
function TriggerRegisterEnterRegionSimple(trig, whichRegion)
	return TriggerRegisterEnterRegion(trig, whichRegion, DoNothing or nil)
end
-- ===========================================================================

function TriggerRegisterLeaveRegionSimple(trig, whichRegion)
	return TriggerRegisterLeaveRegion(trig, whichRegion, DoNothing or nil)
end
-- ===========================================================================
...
function TriggerRegisterEnterRectSimple(trig, r)
	...
	return TriggerRegisterEnterRegion(trig, rectRegion, DoNothing or nil)
end
-- ===========================================================================
...
function TriggerRegisterLeaveRectSimple(trig, r)
	local rectRegion = CreateRegion()
	RegionAddRect(rectRegion, r)
	return TriggerRegisterLeaveRegion(trig, rectRegion, DoNothing or nil)
end
-- ===========================================================================
...
function TriggerRegisterUnitInRangeSimple(trig, range, whichUnit)
	return TriggerRegisterUnitInRange(trig, whichUnit, range, DoNothing or nil)
end
-- ===========================================================================
...
function TriggerRegisterDestDeathInRegionEvent(trig, r)
	...
	bj_destInRegionDiesCount = 0
	EnumDestructablesInRect(r, DoNothing or nil, RegisterDestDeathInRegionEnum)
end
-- ***************************************************************************
-- 
...
function EnumItemsInRectBJ(r, actionFunc)
	EnumItemsInRect(r, DoNothing or nil, actionFunc)
end
-- ===========================================================================
...
function CreatePermanentCorpseLocBJ(style, unitid, whichPlayer, loc, facing)
	...
	TimerStart(bj_delayedSuspendDecayTimer, 0.05, false, DoNothing or nil)
	return bj_lastCreatedUnit
end
-- ===========================================================================
...
function WakePlayerUnits(whichPlayer)
	local g = CreateGroup()
	GroupEnumUnitsOfPlayer(g, whichPlayer, DoNothing or nil)
...
function PauseAllUnitsBJ(pause)
	...
	while true do
		...
		GroupEnumUnitsOfPlayer(g, indexPlayer, DoNothing or nil)
...
function EnumDestructablesInRectAll(r, actionFunc)
	EnumDestructablesInRect(r, DoNothing or nil, actionFunc)
end
-- ===========================================================================
...
function RandomDestructableInRectSimpleBJ(r)
	return RandomDestructableInRectBJ(r, DoNothing or nil)
end
-- ===========================================================================
...
function NudgeObjectsInRect(nudgeArea)
	...
	g = CreateGroup()
	GroupEnumUnitsInRect(g, nudgeArea, DoNothing or nil)
...
function NearbyElevatorExists(x, y)
	...
	bj_elevatorNeighbor = nil
	EnumDestructablesInRect(r, DoNothing or nil, NearbyElevatorExistsEnum)
	RemoveRect(r)
...
function ChangeElevatorWallBlocker(x, y, facing, open)
	...
	r                      = Rect(x - findThreshold, y - findThreshold, x + findThreshold, y + findThreshold)
	bj_elevatorWallBlocker = nil
	EnumDestructablesInRect(r, DoNothing or nil, FindElevatorWallBlockerEnum)
	RemoveRect(r)
...
function GetUnitsInRectAll(r)
	return GetUnitsInRectMatching(r, DoNothing or nil)
end
-- ===========================================================================
...
function GetUnitsInRangeOfLocAll(radius, whichLocation)
	return GetUnitsInRangeOfLocMatching(radius, whichLocation, DoNothing or nil)
end
-- ===========================================================================
...
function GetUnitsOfPlayerAll(whichPlayer)
	return GetUnitsOfPlayerMatching(whichPlayer, DoNothing or nil)
end
-- ===========================================================================
...
function GetUnitsSelectedAll(whichPlayer)
	local g = CreateGroup()
	SyncSelections()
	GroupEnumUnitsSelected(g, whichPlayer, DoNothing or nil)
	return g
end
-- ===========================================================================
...
function GetPlayersAllies(whichPlayer)
	local f = CreateForce()
	ForceEnumAllies(f, whichPlayer, DoNothing or nil)
	return f
end
-- ===========================================================================
...
function GetPlayersEnemies(whichPlayer)
	local f = CreateForce()
	ForceEnumEnemies(f, whichPlayer, DoNothing or nil)
	return f
end
-- ===========================================================================
...
function MakeUnitsPassiveForPlayer(whichPlayer)
	...
	GroupEnumUnitsOfPlayer(playerUnits, whichPlayer, DoNothing or nil)
...
function StartTimerBJ(t, periodic, timeout)
	...
	TimerStart(t, timeout, periodic, DoNothing or nil)
...
function CreateTimerBJ(periodic, timeout)
	bj_lastStartedTimer = CreateTimer()
	TimerStart(bj_lastStartedTimer, timeout, periodic, DoNothing or nil)
	return bj_lastStartedTimer
end
-- ===========================================================================
...
function TryInitRescuableTriggersBJ()
	...
	if (bj_rescueUnitBehavior == nil) then
		...
		index                 = 0
		while true do
			TriggerRegisterPlayerUnitEvent(bj_rescueUnitBehavior, Player(index), EVENT_PLAYER_UNIT_RESCUED, DoNothing or nil)
			index = index + 1
			if index == bj_MAX_PLAYER_SLOTS then break end
		end
...
function MeleeClearNearbyUnits(x, y, range)
	...
	GroupEnumUnitsInRange(nearbyUnits, x, y, range, DoNothing or nil)
...
function MeleeFindNearestMine(src, range)
	...
	GroupEnumUnitsInRangeOfLoc(nearbyMines, src, range, DoNothing or nil)
...
function MeleePlayerIsCrippled(whichPlayer)
	...
	local playerKeyStructures = MeleeGetAllyKeyStructureCount(whichPlayer)
...
function MeleeInitVictoryDefeat()
	...
	while true do
		...
		if (GetPlayerSlotState(indexPlayer) == PLAYER_SLOT_STATE_PLAYING) then
			...
			trig = CreateTrigger()
			TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_CONSTRUCT_CANCEL, DoNothing or nil)
			TriggerAddAction(trig, MeleeTriggerActionConstructCancel)
			
			--  Set a trigger to fire whenever a unit dies for this player.
			trig = CreateTrigger()
			TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_DEATH, DoNothing or nil)
			TriggerAddAction(trig, MeleeTriggerActionUnitDeath)
			
			--  Set a trigger to fire whenever a unit begins construction for this player
			trig = CreateTrigger()
			TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_CONSTRUCT_START, DoNothing or nil)
...
function InitBlizzardGlobals()
	...
	ForceEnumPlayers(bj_FORCE_ALL_PLAYERS, nil or DoNothing)
...
function UpdateEachStockBuilding(iType, iLevel)
	...
	g                       = CreateGroup()
	GroupEnumUnitsOfType(g, "marketplace", DoNothing or nil)
...
function InitNeutralBuildings()
	...
	TriggerRegisterPlayerUnitEvent(bj_stockItemPurchased, Player(PLAYER_NEUTRAL_PASSIVE), EVENT_PLAYER_UNIT_SELL_ITEM, DoNothing or nil)
